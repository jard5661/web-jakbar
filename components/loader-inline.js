// Alternative Component Loader - Inline Version
// This version doesn't use fetch, so it works without a server
// BUT: You need to update components manually in this file
    ...
    <div class="container mx-auto px-4">
        ...
        <nav class="hidden md:block pb-4">
            <ul class="flex flex-wrap gap-2">
                <li><a href="{{HOME_URL}}" class="nav-btn px-4 py-2 rounded-lg hover:bg-blue-700 transition" data-page="home">Home</a></li>
                ...
                <li class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="{{FPK_URL}}">FPK</a>
                        <a href="{{FKUB_URL}}">FKUB</a>
                        <a href="{{FKDM_URL}}">FKDM</a>
                    </div>
                </li>
                ...
                <li class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="{{PARPOL_URL}}">Partai Politik</a>
                        <a href="{{ORMAS_URL}}">Ormas Terlapor</a>
                        <a href="{{PENGAWASAN_URL}}">Tim Pengawasan Ormas</a>
                    </div>
                </li>

                <li><a href="{{EKONOMI_URL}}" class="nav-btn px-4 py-2 rounded-lg hover:bg-blue-700 transition" data-page="ekonomi">Data Ekonomi</a></li>
                ...
                <li class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="{{PETA_KRIMINAL_URL}}">Peta Kriminal</a>
                        <a href="{{PETA_KONFLIK_URL}}">Peta Konflik</a>
                        <a href="{{PETA_ORANG_ASING_URL}}">Peta Orang Asing</a>
                    </div>
                </li>
            </ul>
        </nav>
        ...
        <div id="mobileMenu" class="mobile-menu md:hidden">
            <ul class="flex flex-col gap-2 pb-4">
                <li><a href="{{HOME_URL}}" class="nav-btn block w-full text-left px-4 py-2 rounded-lg hover:bg-blue-700 transition" data-page="home">Home</a></li>
                ...
                <li>
                    ...
                    <div id="forum-dropdown" class="mobile-dropdown-content">
                        <a href="{{FPK_URL}}" class="block py-2">FPK</a>
                        <a href="{{FKUB_URL}}" class="block py-2">FKUB</a>
                        <a href="{{FKDM_URL}}" class="block py-2">FKDM</a>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div id="politik-dropdown" class="mobile-dropdown-content">
                        <a href="{{PARPOL_URL}}" class="block py-2">Partai Politik</a>
                        <a href="{{ORMAS_URL}}" class="block py-2">Ormas Terlapor</a>
                        <a href="{{PENGAWASAN_URL}}" class="block py-2">Tim Pengawasan Ormas</a>
                    </div>
                </li>

                <li><a href="{{EKONOMI_URL}}" class="nav-btn block w-full text-left px-4 py-2 rounded-lg hover:bg-blue-700 transition" data-page="ekonomi">Data Ekonomi</a></li>
                ...
                <li>
                    ...
                    <div id="peta-dropdown" class="mobile-dropdown-content">
                        <a href="{{PETA_KRIMINAL_URL}}" class="block py-2">Peta Kriminal</a>
                        <a href="{{PETA_KONFLIK_URL}}" class="block py-2">Peta Konflik</a>
                        <a href="{{PETA_ORANG_ASING_URL}}" class="block py-2">Peta Orang Asing</a>
                    </div>
                </li>
            </ul>
        </div>
...
// Load navbar component (inline)
function loadNavbar() {
    const currentPath = window.location.pathname;
    const isIndexPage = currentPath === '/' || currentPath.endsWith('/index.html') || currentPath.endsWith('/web-jakbar/') || currentPath.endsWith('/web-jakbar');
